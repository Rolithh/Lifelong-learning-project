# -*- coding: utf-8 -*-
"""
Created on Tue Feb  9 12:35:45 2021
...
class ContinualJacquardLoader2:
    ...
    def get_data(self, phase, index):
        ...
        dataset = JacquardSubDataset2(paths, phase, self.img_size)
    ...
    def __getitem__(self, index):
        return self.get_data('test', index)
    ...
    def __next__(self):
        if self.iter < self.task_n:
           self.iter += 1
           return self.get_data('test', self.iter -1)
        else:
           raise StopIteration
        


class JacquardSubDataset2(torch.utils.data.Dataset):
...
#exemple = ContinualJacquardLoader2(data_path)
#print(exemple[0])
#print(len(exemple))
...
#exemple2 = JacquardSubDataset2(objectpath, 'test')
