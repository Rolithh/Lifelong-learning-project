...
def train(scholar, dataset, replay_mode,
          generator_lambda=10.,
    ...
    for task, train_dataset in enumerate(dataset, 1):
        ...
        #     None
        # )
        utils.save_checkpoint(scholar, checkpoint_dir, task)
...
def _solver_training_callback(
    ...
    def cb(solver, progress, batch_index, result):
        ...
        #     precs = [
        #         utils.validate(
        #             solver, test_datasets.get_data('test', i), test_size=test_size,
